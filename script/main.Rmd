...
output:
  html_document:
    theme: lumen  # Changer le thème en "lumen"
---
...
generer_combinaisons <- function(chiffre) {
  ...
  # Retourner les libellés concaténés avec des tirets "-"
...
# Utilisation de paste0 pour combiner les chiffres en nombres à deux chiffres
all_combinaison_chiffre <- paste0(combinaisons$Var1, combinaisons$Var2)

# Ajout des entiers de 1 à 6 à la variable "nombres"
...
base_tp2_recode$occupation <- case_when(
  ...
  TRUE ~ as.character(base_tp2_recode$occupation)  # Conserver toutes les autres valeurs inchangées
)
...
On remarque que les agriculteurs non scolarise sont dominant .
